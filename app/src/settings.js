...
const settings = {
    ...
    API_BASE: '/api/',
    AUTH_TOKEN_NAME: 'knowledge_graphql_microservices_token',
    // KEEP `AUTH_TOKEN_LIFETIME` IN SYNC WITH backend ACCESS_TOKEN_LIFETIME
    AUTH_TOKEN_LIFETIME: 30, // This value is in minutes
    AUTH_REFRESH_TOKEN_NAME: 'knowledge_graphql_microservices_refresh_token',
...
if (process.env.BUILD_TARGET === 'server') {
    ...
    settings.LOGGING_DIR =
        process.env.RAZZLE_LOGGING_DIR || '/var/log/knowledge_graphql_microservices/';
