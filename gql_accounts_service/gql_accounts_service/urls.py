...
from gql_accounts_service.views import WithDataLoadersGraphQLView
...
urlpatterns = [
    ...
    url(r"^graphql$", csrf_exempt(jwt_cookie(WithDataLoadersGraphQLView.as_view(graphiql=settings.DEBUG)))),
]
