...
${prefix}_DATABASE_NAME=knowledge_graphql_microservices
${prefix}_DATABASE_USER=knowledge_graphql_microservices
...
def defaults():
    ...
    env.code_dir = '/srv/knowledge_graphql_microservices'
        ...
        "letsencrypt": [
            {
                ...
                "filename": "letsencrypt.knowledge_graphql_microservices.conf",
        ...
        "nginx": [
            {
                ...
                "filename": "app.knowledge_graphql_microservices.include",
                "remote_path": "/etc/nginx/conf.d/%(filename)s"
            },
            {
                "pattern": "common.knowledge_graphql_microservices.node.include",
                "filename": "common.knowledge_graphql_microservices.node.include",
                "remote_path": "/etc/nginx/conf.d/%(filename)s"
            },
            {
                "pattern": "common.knowledge_graphql_microservices.django.include",
                "filename": "common.knowledge_graphql_microservices.django.include",
                "remote_path": "/etc/nginx/conf.d/%(filename)s"
            },
            {
                "pattern": "app.knowledge_graphql_microservices.proxy_django.include",
                "filename": "app.knowledge_graphql_microservices.proxy_django.include",
                "remote_path": "/etc/nginx/conf.d/%(filename)s"
            },
            {
                "pattern": "app.knowledge_graphql_microservices.proxy_node.include",
                "filename": "app.knowledge_graphql_microservices.proxy_node.include",
                "remote_path": "/etc/nginx/conf.d/%(filename)s"
            },
            {
                "pattern": "app.knowledge_graphql_microservices.proxy.include",
                "filename": "app.knowledge_graphql_microservices.proxy.include",
                "remote_path": "/etc/nginx/conf.d/%(filename)s"
            },
            {
                "pattern": "%(target)s.ssl",
                "filename": "ssl.knowledge_graphql_microservices.include",
                "remote_path": "/etc/nginx/conf.d/%(filename)s"
            },
            {
                "default_site": True,
                "pattern": "%(target)s.conf",
                "filename": "knowledge_graphql_microservices",
...
def test():
    ...
    defaults()
    env.node_site = 'knowledge-graphql-microservices.test.TODO.com'
    env.django_site = 'office.knowledge-graphql-microservices.test.TODO.com'
...
def setup_server(id=None):
    ...
    django_settings_file = env.code_dir + '/knowledge_graphql_microservices/django.env'
    ...
    # Create database
    sudo('echo "CREATE DATABASE knowledge_graphql_microservices; '
         '      CREATE USER knowledge_graphql_microservices WITH password \'{db_password}\'; '
         '      GRANT ALL PRIVILEGES ON DATABASE knowledge_graphql_microservices to knowledge_graphql_microservices;" '
         '| docker exec -i postgres-{postgres_version} psql -U postgres'.format(db_password=db_password,
                                                                                postgres_version=env.postgres_version))
    # Create log dir
    sudo('mkdir -p /var/log/knowledge_graphql_microservices/')
    ...
    with cd(env.code_dir):
        sudo('cp deploy/logrotate.conf /etc/logrotate.d/knowledge_graphql_microservices')
...
def add_secret_keys(component=None):
    ...
    if component == 'node':
        ...
        remote_path = env.code_dir + '/knowledge_graphql_microservices/django.env'
...
def collectstatic():
    docker_compose_run('node', 'yarn export-assets', name='knowledge_graphql_microservices_yarn_export')
...
def docker_compose_run(service, cmd='', name='knowledge_graphql_microservices_tmp'):
...
def ensure_docker_networks():
    ...
    ensure_docker_network_exists('knowledge_graphql_microservices_default', [], internal=False)
    ensure_docker_network_exists('knowledge_graphql_microservices_nginx', ['nginx'])
    ensure_docker_network_exists('knowledge_graphql_microservices_postgres', ['postgres-{postgres_version}'.format(
        postgres_version=env.postgres_version)])
...
def ensure_local_py_exists():
    ...
    django_local_settings = env.code_dir + '/knowledge_graphql_microservices/settings/local.py'
